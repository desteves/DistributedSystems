...
def drawOrigin(maxValue):
    return numpy.random.uniform(0, maxValue, 2)  # @UndefinedVariable
...
for i in range(0, numClusters):
    ...
    variance = numpy.random.uniform(minClusterVar, maxClusterVar) # @UndefinedVariable
    ...
    for j in range(0, numPoints):
        ...
        x, y = numpy.random.normal(cluster, variance) # @UndefinedVariable
